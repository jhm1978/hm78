...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"(주)감정평가법인 대교","period":"2018 - 현재","description":"대표이사"},{"icon":"graduation","title":"단국대 부동산 건설대학원","period":"2024 ~ 현재","description":"도시 및 부동산 개발"},{"icon":"award","title":"주요 경력","period":"인천지방법원 및 고등법원, 가정법원 지정 감정인,  감정평가사협회 공제사업위원회 위원, 한국부동산원 도시정비사업 전문위원","description":"한국부동산원 지역전문가, 공인중개사"}],
