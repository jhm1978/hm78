...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"(주)감정평가법인 대교","period":"2020 - 현재","description":"직무 및 역할"},{"icon":"graduation","title":"단국대 부동산 건설대학원","period":"2024 ~~ 현재","description":"도시 및 부동산 개발"},{"icon":"award","title":"주요 경력","period":"인천지방법원 및 고등법원, 가정법원 지정 감정인,  감정평가사협회 공제사업위원회 위원, 한국부동산원 도시정비사업 전문위원","description":"한국부동산원 지역전문가, 공인중개사"}],
    skills: [{"icon":"code","title":"유형자산 감정평가","description":"\n-\t재개발, 재건축 감정평가 (종전자산,종후자산,영업보상 평가)\n-\t개발사업관련 감정평가\n-\t법원 경매, 소송 감정평가\n-\t공익사업을 위한 보상평가\n-\t국공유재산 매각, 교환, 관리 및 국가기관 관련 감정평가\n-\t상속세, 증여세 관련 감정평가\n-\t유형 기업자산 평가\n-\t해외부동산 감정평가\n-\t기타감정평가 (일반거래, 어업권, 광업권, 특수부동산 평가 등)"},{"icon":"database","title":"무형자산 감정평가","description":"\n-\t무형자산 감정평가 (특허권, 상표권, 디자인권 등)\n-\t영업권 감정평가"},{"icon":"palette","title":"부동산 컨설팅","description":"-\t개발전략수립\n-\t사업타당성분석\n-\t부동산투자자문"}],
    storyTitle: "나의 이야기",
    story: ["(주)감정평가법인 대교는 21세기 급변하는 사회, 경제환경에 능동적으로 대처하기 위해 최고의 감정평가사들이\n모여 만든 법인으로서 진취적인 정신과 새로운 패러다임으로 부동산 감정평가 업무에 임하고 있습니다.","당사의 감정평가사들은 전문가로서 명예심과 서비스정신을 가지고 고객으로부터 의뢰 받은 평가업무에\n대해 신속 정확히 처리하기 위하여 최선을 다하고 있습니다.","앞으로 감정평가법인 대교는 각고의 노력을 통해 실력과 기량을 배양하여 고객의 요구를 충족시키는\n감정평가법인, 나아가 고객을 감동시키는 감정평가법인을 만들어 가겠습니다.","그리고 국가와 국민의 재산권을 보호할 수 있도록 다양한 평가기법을 끊임없이 연구·개발하여, 더욱\n신뢰받는 법인이 될 수 있도록 노력하겠습니다. 많은 격려와 끊임없는 질책을 부탁드립니다."],
    storyImage: "/uploads/about-image-1764382432486.jpg",
    hobbies: ["등산","골프","헬스","단부건 36기"]
  }
