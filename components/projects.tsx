...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-1764382583914-1764382584038.jpg","video":"","title":"(주)감정평가법인 대교","description":"감정평가"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
